...
<div class="top">
<div class="topbar">
<span class="welcome" style="float:left">欢迎光临企明星电子商城系统 <a href="" class="red">${username }</a>,<a rel="nofollow" href="logout.user">退出</a> </span>
 ...
 <li><a rel="nofollow" href="MyCollect.page">我的收藏</a></li>
 <li><a rel="nofollow" href="changePassword.page">修改密码</a></li>
</ul>		  
  
	|</span>		  
	<span class="operate_nav">	 
 <a rel="nofollow" href="index.cart">我的订单</a>
| </span>		
 <span class="operate_nav">	 
...
<div class="header-wrap"><a href="${pageContext.request.contextPath}/" class="logo" title="企明星电子商城系统"><img src="${pageContext.request.contextPath}/images/logo.png" alt=""></a>
...
<div class="shopping_cart_procedure3"><span>1、我的购物车</span><span>   2、填写订单</span><span style="width:175px; padding:0;">3、完成订单</span>  </div>
	...
	<div class="wrapper-order">
		...
		<div style="width: 700px;height:500px;margin: auto">
			<p><strong style="color:#35AA47;clear:both;font-size:25px;">1,付款对公账号为:(</strong><strong style="color:red;clear:both;font-size:25px;">00000005038766723012</strong><strong style="color:#35AA47;clear:both;font-size:25px;">)&nbsp;请手动打款</strong></p>
			<br>
			<p><strong style="color:#35AA47;clear:both;font-size:25px;">2,可使用支付宝或者微信支付,支付过后我们会在三天之内处理</strong></p>
			<br>
			<img src="${pageContext.request.contextPath}/images/zhifu.jpg" width="100%"height="100%">
		</div>
		<br>
		<br>
		<br>
...
<p style="margin: auto;width: 600px"><a class="btn_success" rel="nofollow" href="${pageContext.request.contextPath}/">继续购物</a><a class="btn_success" rel="nofollow" href="${pageContext.request.contextPath}/userMain.page?type=1">查看订单</a></p></div>
