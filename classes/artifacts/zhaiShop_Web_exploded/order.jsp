...
var Account= document.getElementById('account');
  ...
  <div class="wrapper-address"> 
   ...
   <div class="header-wrap">
    <a href="${pageContext.request.contextPath}/" class="logo" title="企明星电子商城系统"><img src="${pageContext.request.contextPath}/images/logo.png" alt="" /></a>
...
{if(data.msg=="yes"){
	...
	$("span.tips").html(data.info);
     ...
     <div class="orderplace"> 
      <link type="text/css" href="${pageContext.request.contextPath}/css/selectpick.css" rel="stylesheet" />
      <div class="o_title"> 
      ...
      <div id="formwarp" class="place"> 
       ...
       <c:forEach items="${addressList }" var="ord">
       	<p>
       	<c:if test="${ord.msg==1 }">
       		<input type="radio" checked="checked" id="default" name="sender" width="5" value="${ord.id }" />&nbsp;收件人：${ord.username }&nbsp;&nbsp;联系电话:${ord.phone }&nbsp;&nbsp;收货地址：${ord.province }${ord.city }${ord.area }${ord.address }
       	</c:if>
       	<c:if test="${ord.msg!=1 }">
