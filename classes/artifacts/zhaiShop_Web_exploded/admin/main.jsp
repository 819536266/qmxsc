...
<table style="padding: 5px;" width="100%">
	<tr>
		<td width="50%"><div style="width:100px;height: 50px;background-color: #1088e2 "><img width="100px" height="50px" src="${pageContext.request.contextPath}/images/logo.png"/></div></td>
...
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px;"><font color="red" size="10">欢迎使用企明星电子商城后台管理系统</font></div>
		</div>
	</div>
</div>
