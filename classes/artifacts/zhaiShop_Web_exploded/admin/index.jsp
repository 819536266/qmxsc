...
<html>
  ...
  <%--<c:remove var="state" scope="企明星"/>--%>
    <div class="login">
    <div class="box png">
		<div class="logo png"></div>
		<div class="input">
		<form action="${pageContext.request.contextPath}/adminLogin.user" method="post">
			<div class="log">
				<div class="name">
				...
				<div class="pwd">
					...
					<label>验证码</label><input type="text" class="text" id="value_1" placeholder="验证码" name="jyzm" tabindex="3" style="margin-top: 10px;width: 100px;"><img id="CreateCheckCode" src="${pageContext.request.contextPath}/genImage.yzm" onclick="changeImage()">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/adminLoginRQQ.js"></script>
  </body>
</html>
