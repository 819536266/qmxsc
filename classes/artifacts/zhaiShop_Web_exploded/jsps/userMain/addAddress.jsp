...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/select2Address/js/area.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/select2Address/js/location.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/select2Address/js/select2.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/select2Address/js/select2_locale_zh-CN.js"></script>
<link href="${pageContext.request.contextPath}/js/select2Address/css/select2.css" rel="stylesheet"/>
