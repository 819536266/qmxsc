...
<div class="yershop_wrapper">
   <div class="commom_wrapper"> 
    ...
    <div class="main"> 
     <div class="main_nav">
      <a rel="nofollow" href="${pageContext.request.contextPath}/"><i class="glyphicon glyphicon-home"></i>首页</a>&gt;
...
$("#inputparameters").val(para);
         ...
         <!-- buy--> 
         <p> <span>收藏产品：<a href="javascript:void(0);" onclick="favor();return false;"><img title="收藏" src="${pageContext.request.contextPath}/images/icon_favorite_pro.jpg" /></a> </span> &nbsp;&nbsp;&nbsp;&nbsp;
         <span>&nbsp;&nbsp;&nbsp;分享到：<a title="分享到新浪微博" target="_blank" href="http://service.weibo.com/share/share.php?title=${goodsBean.name}（来自企明星电子商城）&url=${pageContext.request.contextPath}/goodsPageServlet?id=${goodsBean.id}&pic=${pageContext.request.contextPath}/${goodsBean.proPic}" data-item="sina" class="J_vivo_share"> <img alt="新浪微博" src="${pageContext.request.contextPath}/images/icon_sina_weibo.jpg" app="b2c" /> </a>
         <a title="分享到腾讯微博" target="_blank" href="http://v.t.qq.com/share/share.php?title=${goodsBean.name}（来自企明星电子商城）&url=${pageContext.request.contextPath}/goodsPageServlet?id=${goodsBean.id}&pic=${pageContext.request.contextPath}/${goodsBean.proPic}" data-item="tencent" class="J_vivo_share"> <img alt="腾讯微博" src="${pageContext.request.contextPath}/images/icon_tencent_weibo.jpg" app="b2c" /> </a>
        <%-- <a target="_blank" title="分享到人人网" href="http://widget.renren.com/dialog/share?resourceUrl=${pageContext.request.contextPath}/goodsPageServlet?id=${goodsBean.id}&amp;title=${goodsBean.name}（来自企明星电子商城）&amp;pic=${pageContext.request.contextPath}/${goodsBean.proPic}" data-item="renren" class="J_vivo_share"> <img alt="人人网" src="${pageContext.request.contextPath}/images/icon_renrenwang.jpg" app="b2c" /> </a> </span></p>--%>
...
$(function(){
   $(".jqzoom").jqueryzoom({
	...
	_back:"#spec-left"
       ...
       <script src="${pageContext.request.contextPath}/js/jqueryzoom-jcarousel.js" type="text/javascript"></script>
       <!-- js over--> 
       <!-- jqzoom over--> 
       <!-- 商品参数--> 
...
document.fiveform.submit();
        ...
        <div class="good-tabs"> 
         <ul> 
          <a href="" id="detail_tab" name="__tab_detail_b2c" rel="header1" class="on selected">商品详情</a>
         </ul> 
        </div> 
    ...
    <div id="dialog"> 
     ...
     <div id="myModal" class="modal"> 
      <div class="modal-header"> 
       <a class="close" onclick="closeBg();"><img src="${pageContext.request.contextPath}/images/close.png" /></a>
       <h3 id="myModalLabel">用户登录</h3> 
      </div>
      <%--<div class="m_img">
         &lt;%&ndash;<a class="" href="#"><img src="${pageContext.request.contextPath}/images/qq.png" />&nbsp;用QQ账号登录</a>
         <br />
         <br />
         <a class="" href="#"><img src="${pageContext.request.contextPath}/images/weibo.png" />&nbsp;用微博账号登录</a>
         <!--<a class="btn btn-warning btn-block" href="">用豆瓣账号登录</a>
          <a class="btn btn-primary btn-block" href="">用人人账号登录</a>-->&ndash;%&gt;
     </div>--%>
         <form class="form-horizontal" id="loginform" name="user" method="post">
       <div class="form_login">
           <font size="4" face="楷体">用户名:</font><input type="text" style="left: 20px" id="inputusername" name="username" placeholder="用户名"  />
       </div>
       <div class="form_login">
           <font size="4" face="楷体">密&nbsp;&nbsp;码:</font><input type="password" style="left: 20px" id="inputpassword" name="password" placeholder="密码" />
       </div> 
       ...
       <div class="control-group" style="height: 30px;">
        <span class="pull-right"><h3 style="text-align: center;line-height: 30px">还没有账号? <a href="rege.jsp" class="now">立即注册</a></h3> </span>
       </div> 
      </form> 
     </div> 
     <!-- Modal 对话框内容 --> 
