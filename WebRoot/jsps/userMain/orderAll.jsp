...
<span <c:if test="${type=='1'}">class="active"</c:if>><a href="${pageContext.request.contextPath}/userMain.page?type=1" class="red">所有订单</a></span>
<span <c:if test="${type=='2'}">class="active"</c:if>><a href="${pageContext.request.contextPath}/userMain.page?type=2" class="red">待支付订单</a></span>
<span <c:if test="${type=='3'}">class="active"</c:if>><a href="${pageContext.request.contextPath}/userMain.page?type=3" class="red">待发货订单</a></span>
<span <c:if test="${type=='4'}">class="active"</c:if>><a href="${pageContext.request.contextPath}/userMain.page?type=4" class="red">待确认订单</a></span>
</div>
	  ...
	  <span class="good-status">交易状态</span> <span class="deal-action">交易操作</span></div>
		...
		<!-- 左边商品区域开始 -->  
		  ...
		  <c:forEach items="${ordrList.itemList }" var="goods">
			  <div class="cos">
			  <span class="c1"><a href="${pageContext.request.contextPath}/goodsPageServlet?id=${goods.goodsId }" class="dl"> <img src="${goods.proPic }" width="70" height="70"></a>
			  <span class="dd"><a href="${pageContext.request.contextPath}/goodsPageServlet?id=${goods.goodsId }" class="dd"> ${goods.goodsName }</a></span>
			 <span class="dd"></span>
			  </span>
