...
var html="<div class='shopcart_main_none'><div class='shopcart_main_none_img'></div><div class='shopcart_main_none_main'><p>你的购物车还是空的哦赶紧行动吧!</p><a  href='${pageContext.request.contextPath}/'>马上购物</a></div>";
if(obj.rel=="del")
{ var string=obj.name;
//删除数据
$.ajax({
